                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                      ...
                      <!-- Account -->
                      <div class="card-body">
                        <form id="formAccountSettings" method="POST" enctype="multipart/form-data" action="{{ route('mandor.update_profile') }}">
                          @csrf
                          ...
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input type="number" id="no_hp" name="no_hp" class="form-control" value="{{ auth()->user()->no_hp }}"  placeholder="876 543 210">
                                @error('no_hp')
                                <p class="small text-danger">{{$message}}</p>
                                @enderror
                              </div>
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $mandor->alamat }}" placeholder="Masukan Alamat">
                              @error('alamat')
                              <p class="small text-danger">{{$message}}</p>
                              @enderror
                            </div>
