        ...
        <div class="layout-container">
          ...
          <div class="layout-page">
            ...
            <div class="content-wrapper">
              <div class="container">
                <div class="row p-4">
                    <div class="col-md-12 bg-white shadow table-responsive rounded-3">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <a class="m-1" href="{{ route('admin.edit_kepala',$item->id)}}">
                                            ...
                                            <a href="{{ route('admin.destroy',$item->id)}}" class="m-1 border-0 bg-transparent text-danger" type="submit">
