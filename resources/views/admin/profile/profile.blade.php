                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="card mb-4">
                        ...
                        <!-- Account -->
                        <div class="card-body">
                          <form id="formAccountSettings" enctype="multipart/form-data" method="POST" action="{{ route('admin.update_profile')}}">
                            @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="alamat" name="alamat" value="" placeholder="Masukan Alamat">
                                @error('alamat') 
                                <p class="small text-danger">{{$message}}</p>
                                @enderror 
                              </div>
