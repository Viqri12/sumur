                            ...
                            <form id="formAccountSettings" method="POST" onsubmit="return false">
                              <div class="row">
                                <div class="mb-3 col-md-6">
                                  ...
                                  <input class="form-control" type="text" id="name" name="name" autofocus="" placeholder="Masukan Nama">
                                  @error('name')
                                ...
                                <div class="mb-3 col-md-6">
                                  ...
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="no_hp" name="no_hp" class="form-control" placeholder="876 543 210">
                                    @error('no_hp')
                                    <p class="small text-danger">{{$message}}</p>
                                    @enderror
                                  </div>
